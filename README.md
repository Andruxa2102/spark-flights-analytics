Приложение для анализа данных о авиаперелетах с поддержкой инкрементальной обработки.
...
- **--topTenAirportsSortDesc**          - изменить порядок сортировки ASC -> DESC в метрике **topTenAirportsMetrics**
- **--topTenAirlinesSortDesc**          - изменить порядок сортировки ASC -> DESC в метрике **topTenAirlinesMetrics**
- **--topAirportsPerAvialinesSortDesc** - изменить порядок сортировки ASC -> DESC в метрике **topTenAirportsPerAvialinesMetrics**
- **--topTenDestinationsSortDesc**      - изменить порядок сортировки ASC -> DESC в метрике **topTenDestinationsMetrics**
